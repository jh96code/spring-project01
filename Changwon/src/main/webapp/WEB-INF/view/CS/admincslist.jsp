	...
	<main>
		<div class="container w-75 mt-5 mx-auto">
				<div class="d-flex justify-content-between align-items-center">	
                	<h2>문의 목록<span style="font-size:19px;"> (관리자용)</span></h2>
                	<strong>클릭해서 상세 문의내용을 확인후 답변을 달아보세요.</strong>
                </div>
				<hr>
		            ...
		            <tbody>
		                ...
		                <c:forEach var="cslist" items="${cslist}" varStatus="status">
		                	<tr class="cs" style="cursor: pointer;">
			                    ...
			                    <th>
			                    	<a href="deletecs?num=${cslist.num}&id=<%=loginid%>" class="btn btn-danger" style="padding:0px 4px;">삭제</a>
			                    </th>
			              	</tr>
								<tr class="reply">
									<td colspan="5"> <br>
										<div class="col-12 row">
											<label class="col-1 control-label"><b>문의유형:</b></label>
											<input class="col-4" value="${cslist.category}" readonly>
										</div> <br>
										<div class="col-12 row">
											<label class="col-1 control-label"><b>문의내용:</b></label>
											<input class="col-10" value="${cslist.content}" readonly>
										</div> <br><hr><br>
										<c:choose>
											<c:when test="${empty cslist.reply_day}">
												<form action="csreply?id=${loginid}&num=${cslist.num}" method="post" name="replyCS">
													<div class="col-12 row">
														<label class="col-1 control-label" style="color:#c70000;"><b>답변자 아이디:</b></label>
														<input type="text" class="col-4" name="reply_member_id" value="${loginid}" readonly>
													</div> <br>
													<div class="col-12 row">
														<label class="col-1 control-label" style="color:#c70000;"><b>답변 내용:</b></label>
														<input type="text" class="col-10" name="reply_content" placeholder="내용을 입력하세요." >
													</div> <br>
													<div class="d-flex justify-content-end col-12">
														<input class="btn btn-primary" type="submit" value="답변 달기">
													</div><br>
												</form>
											</c:when>
											<c:otherwise>
