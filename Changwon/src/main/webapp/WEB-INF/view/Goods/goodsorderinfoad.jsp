	...
	<div class="container col-8 alert alert-info">
		...
		<div class="row justify-content-between">
			<div class="col-4" align="left">
				<a href="addresssel?id=${adrselect.addressId }" class = "btn btn-success" >배송지 변경</a><br>
				
				<strong>배송주소 : ${adrselect.addressAdr}</strong>  
				<br>수령인 성명 : ${adrselect.addressName}	
				<br>수령인 전화번호 : ${adrselect.addressPhone} 
				<br>
		...
		<form action="orderOK" method="post" name="orderForm">
			...
			<a href="goodsorderOK?id=${adrselect.addressId }" class="btn btn-success" role="button">주문 완료</a>
